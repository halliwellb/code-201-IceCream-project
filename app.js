...
let wantsASunday = prompt('Can we make you a sunday?');
let toppings = ['Hot Fudge'; 'Cherries'; 'Sprinkles'; 'Bubblegum'];

if (wantsASunday == 'yes') {
    alert('Awesome! We have lots of variety!');
    let iceCreamFlavor = prompt('What kind of icecream would you like? We have chocolate, vanilla, and coffee.')
    ...
    if(iceCreamFlavor === 'chocolate' || iceCreamFlavor === 'vanilla' || iceCreamFlavor === 'cofee') {
        ...
        let toppingOne = prompt('What would you like for your first topping?');
        alert(toppingOne + ', great! What else?');
        let toppingTwo = prompt('What would you like for your second topping, in addition to ${toppingOne}?');
